#create a function to handle common database actions like insert, update & delete
import logging

logger = logging.getLogger(__name__)
table = "yt_api"

#define function to insert api data that was loaded from the json file into the staging and core tables
...
#create a function for instances where a channel deletes a video, as it might lead to incorrect data in the tables
